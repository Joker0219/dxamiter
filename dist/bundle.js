...
(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.dxamiter = factory());
    ...
    function injectPromise(callback) {
    ...
    function handlePrefs() {
        return {
            fp: function (callback) {
                callback();
            },
            fcp: function (callback) {
                callback();
            },
            fmp: function (callback) {
                callback();
            }
        };
    }
    ...
    class AsyncTaskQueue {
        constructor() {
            this.debounceRun = lodash.debounce(this.run.bind(this), 1000);
        }
        get storableService() {
    ...
    // 
    /** */
    class BaseTrack extends AsyncTaskQueue {
        constructor() {
            super(...arguments);
            this.seq = 0;
        }
        ...
        track(data) {
            if (data) {
                ...
                this.addTask(Object.assign({ id: v4(), seqId: this.seq++, timestamp: Date.now() }, data));
            }
        }
    }
